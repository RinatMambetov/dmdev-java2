package com.rinat.lesson25.hw;

import com.rinat.lesson25.hw.model.RobotDetail;
import com.rinat.lesson25.hw.model.Scientist;
import com.rinat.lesson25.hw.thread.Factory;
import com.rinat.lesson25.hw.thread.Night;
import com.rinat.lesson25.hw.thread.ScientistAssistant;
import com.rinat.lesson25.hw.util.RandomUtil;
import com.rinat.lesson25.hw.util.ThreadUtil;
...
public class FactoryDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ScientistAssistant badScientistAssistant = new ScientistAssistant(new Scientist("Плохой ученый"),
                factory.getDump(), night);
        ScientistAssistant goodScientistAssistant = new ScientistAssistant(new Scientist("Хороший ученый"),
                factory.getDump(), night);
