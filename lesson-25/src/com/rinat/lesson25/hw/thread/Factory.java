package com.rinat.lesson25.hw.thread;

import com.rinat.lesson25.hw.model.Dump;
import com.rinat.lesson25.hw.model.RobotDetail;
import com.rinat.lesson25.hw.util.NightConst;
        ...
        synchronized (dump.getLock()) {
            for (int j = 0; j < countDetailsForThrowingToDump; j++) {
                RobotDetail robotDetail =
                        RobotDetail.CASHED_VALUES.get(RandomUtil.getNext(RobotDetail.CASHED_VALUES.size()));
